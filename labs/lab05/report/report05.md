...
![Выполнение пукта №2](image/5.png){ #fig:005 width=70% }

![Продолжение пункта №2](image/6.png){ #fig:006 width=70% }
...
![Работа с правами для файлов и катологов](image/8.png){ #fig:008 width=70% }

![Работа с провами №2](image/9.png){ #fig:009 width=70% }
